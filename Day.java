...
//                                if (mondaySwitches.get(i).getType().equals(type) && !mondaySwitches.get(i).getState()){
//                                    newPosition = i;
//                                }
//                            }
//                        }else{
//                            int j = 0;
//                            while(j < mondaySwitches.size() && !mondaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < tuesdaySwitches.size() && !tuesdaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < wednesdaySwitches.size() && !wednesdaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < thursdaySwitches.size() && !thursdaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < fridaySwitches.size() && !fridaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < saturdaySwitches.size() && !saturdaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
...
//                        }else{
//                            int j = 0;
//                            while(j < sundayswitched.size() && !sundaySwitches.get(j).getState()){
//                                j++;
//                            }
//                            newPosition = position + j;
//                        }
